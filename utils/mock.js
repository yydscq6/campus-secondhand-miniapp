...
const products = [
  ...
  { id: 2, name: '高等数学（第七版）上下册', description: '教材全套，高数线代概率论，笔记很少，9成新', category: '书籍教材', price: 45, originalPrice: 120, condition: '二手', imageUrl: '/images/demo/book.jpg', status: 1, sellerId: 3, viewCount: 88, createTime: '2026-05-28 14:30', sellerNickname: '李四', sellerAvatar: '', isFavorite: true },
  { id: 3, name: '小米无线蓝牙耳机 Air2 SE', description: '续航正常，轻微使用痕迹，音质清晰', category: '电子产品', price: 120, originalPrice: 200, condition: '二手', imageUrl: '/images/demo/earphone.jpg', status: 1, sellerId: 2, viewCount: 65, createTime: '2026-05-25 09:15', sellerNickname: '张三', sellerAvatar: '', isFavorite: false },
  ...
  { id: 5, name: '耐克跑步鞋 42码', description: '穿了两个月，尺码不合适，低价出，鞋底无磨损', category: '服饰鞋包', price: 180, originalPrice: 500, condition: '二手', imageUrl: '/images/demo/shoe.jpg', status: 1, sellerId: 2, viewCount: 32, createTime: '2026-05-18 11:20', sellerNickname: '张三', sellerAvatar: '', isFavorite: true },
  ...
  { id: 7, name: '考研英语真题全套', description: '2020-2025真题详解，含作文模板，部分有笔记标注', category: '书籍教材', price: 28, originalPrice: 89, condition: '二手', imageUrl: '/images/demo/engbook.jpg', status: 1, sellerId: 5, viewCount: 76, createTime: '2026-06-03 13:10', sellerNickname: '赵六', sellerAvatar: '', isFavorite: false },
  { id: 8, name: '小米台灯 Pro', description: '护眼台灯，无频闪，色温可调，8成新', category: '生活用品', price: 55, originalPrice: 169, condition: '二手', imageUrl: '/images/demo/lamp.jpg', status: 1, sellerId: 3, viewCount: 44, createTime: '2026-06-02 20:00', sellerNickname: '李四', sellerAvatar: '', isFavorite: false },
  ...
  { id: 12, name: 'Nike双肩包 黑色', description: '经典款，容量大，可放15.6寸电脑，拉链顺滑', category: '服饰鞋包', price: 120, originalPrice: 399, condition: '二手', imageUrl: '/images/demo/bag.jpg', status: 1, sellerId: 3, viewCount: 38, createTime: '2026-06-01 17:50', sellerNickname: '李四', sellerAvatar: '', isFavorite: false },
]
