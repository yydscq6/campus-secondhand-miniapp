...
> 基于微信云开发的校园二手交易平台，采用紫罗兰渐变主题设计，支持商品浏览、发布、交易、评价、议价等完整功能。
...
| 商品 | 详情查看 / 发布 / 编辑 / 删除 | detail / publish / my-products |
...
```
pages/
├── index/          # 首页（轮播 + 分类 + 热门 + 最新）
├── category/       # 分类（标签 + 搜索 + 排序 + 列表）
├── publish/        # 发布（图片 + 表单 + 分类 + 价格）
├── mine/           # 我的（个人中心 + 统计 + 菜单）
├── detail/         # 商品详情（大图 + 价格 + 保障 + 评价）
